...
async function setupServer() {
  ...
  service.logger.trace(
    `${service._traceStack()} - Added '/devices/room/:room' api`,
  );
  ...
  service.logger.trace(
    `${service._traceStack()} - Added '/schedules/active' api`,
  );
